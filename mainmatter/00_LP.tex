...
\end{align*}
%
which yield functions $f_c:\Inp_n\to[0,1],c=1,\ldots,C$. The final output can then either obtained by taking the argmax, i.e. $f:\Inp_n\to\{1,\ldots, C\}$ 
%
\begin{align*}
