...
%
%
Solving this problem is referred to as \emph{attacking} the network $\net$. A method that has gained a lot of popularity is the fast gradient sign method \cite{goodfellow2014explaining}, where one performs only one step of a projected gradient ascent type iteration,
%
\begin{align*}
...
\subsection{Lipschitz Training of Neural Networks}
