...
%
%
The contributions in \cite{roith2022continuum, bungert2021uniform, bungert2022ratio} mainly consider the case of $p=\infty$. However, the case $p<\infty$ is the main motivation for the whole discussion and therefore we quickly review it in the following. Here, we first introduce the continuum setting and then discuss the situation on the graph.
%
%
%
