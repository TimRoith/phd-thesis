\chapter{Consistent Semi-Supervised\phantom{-----} Learning on Sparse Graphs}\label{ch:SSL}
...
\end{align*}
%
Taking the terms on the left and right-hand side to the power of $1/p$ and then formally sending $p\to\infty$ yields
%
\begin{align*}
